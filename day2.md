...
app.get("/",function(req,res){}) -------->   "/" is called route or API, Client requested through req and response "hello world" was send by server when "/" was hitted

"/" is the action and response is the reaction
